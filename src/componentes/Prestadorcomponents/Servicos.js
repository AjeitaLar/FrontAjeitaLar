                ...
                <div className='SecaoLado'>
                    ...
                    <div className='T_Servico'>
                        <fieldset>
                            ...
                            <div>
                                <label for="scales">Encanador</label>
                                <select>
                                    <option>Encanamento</option>
                                    <option>Vazamentos</option>
                                    <option>válvulas de descarga</option>
                                    <option>Desentupir</option>
                                </select>
                            </div>
                            <div>
                                <label for="scales">Pintor</label>
                                <select>
                                    <option>Encanamento</option>
                                    <option>Vazamentos</option>
                                    <option>válvulas de descarga</option>
                            ...
                            <div>
                                <label for="scales">Eletronicos</label>
                                <select>
                                    <option>Encanamento</option>
                                    <option>Vazamentos</option>
                                    <option>válvulas de descarga</option>
                            ...
                            <div>
                                <label for="scales">Instalação</label>
                                <select>
                                    <option>Encanamento</option>
                                    <option>Vazamentos</option>
                                    <option>válvulas de descarga</option>
